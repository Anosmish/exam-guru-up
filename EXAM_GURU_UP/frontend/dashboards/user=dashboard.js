...
function bindEvents() {
    ...
    // Cards
    document.getElementById("papersCard")
        ?.addEventListener("click", () => showSection("papers"));

    document.getElementById("notesCard")
        ?.addEventListener("click", () => showSection("notes"));

    document.getElementById("practicalsCard")
        ?.addEventListener("click", () => showSection("practicals"));

    document.getElementById("projectsCard")
